...
\subsection{Selecting $V^*$} 
A small $V^*$ corresponds to a more efficient circuit. $V^*$ is chosen such that the transistor operates near the sub-threshold region. For this, we select $V^* = 100mV$.
